...
4. **下一跳（NEXT-HOP）到达代价更低**优先：
   - 看域内 IGP 度量。
   
5. **其他 tie-breaker**：如 MED、多出口选择、路由器 ID 等。


**重点：**BGP 更偏向 **策略优先而不是单纯最短路**。
...
ICMP（Internet Control Message Protocol）是 IP 层的“**控制/差错报告协议**”，协议号 1，承载在 IP 数据报中。
